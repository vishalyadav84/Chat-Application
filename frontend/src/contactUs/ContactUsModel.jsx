      ...
      <div className="bg-white p-6 rounded-lg shadow-md   max-w-2xl w-full">
        ...
        <div>
          <p className="mb-4 text-slate-800">
            Hi there! I'm Vishal Yadav, a passionate full-stack developer with
            expertise in MERN stack development. I have years of experience in
                  ...
                  <span
                    ...
                    onClick={() =>
                      (window.location.href =
                        "mailto:shubhanshu.2325mca11@kiet.edu")
                    }
                  >
                    shubhanshu.2325mca11@kiet.edu
                  </span>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <span
                    ...
                    onClick={() =>
                      (window.location.href =
                        "mailto:sumit.2325mca1141@kiet.edu")
                    }
                  >
                    sumit.2325mca1141@kiet.edu
                  </span>
                </td>
              </tr>
            </table>
          ...
          <span>
            If There is any Issue then Mail me by Clicking on Mail.
            <br />
          </span>
          <ContactForm />
